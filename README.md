...
- **Couler un bateau se voit.** Dans l'eau comme sur un simple touché, la case tressaute et c'est tout — c'est sa couleur qui parle. Mais quand un bateau coule, **un 💥 déborde largement sur la grille et une ☠️ s'envole**, la même tête de mort que celle du message. Quand c'est un de tes bateaux qui coule, la ☠️ **sombre** au lieu de monter, et une salve d'explosions court le long de la coque sur ta mini-carte. Tout s'arrête si le système est réglé sur « animations réduites ».
